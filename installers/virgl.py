...
def scripts():
    os.system("wget https://raw.githubusercontent.com/P-Odziomek/Box64Droid/main/scripts/virgl/box64droid &>/dev/null")
    os.system("wget https://raw.githubusercontent.com/P-Odziomek/Box64Droid/main/scripts/non-root/start-box64droid &>/dev/null")
